...
class ResultsOverlayService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "doomsday_results"
    }
    ...
    private fun buildNotification(): Notification {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(CHANNEL_ID, "Analysis Results", NotificationManager.IMPORTANCE_LOW)
        ...
        return builder
            .setContentTitle("Doomsday Analysis")
            .setContentText("Results ready")
